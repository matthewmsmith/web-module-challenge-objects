...
const burger = { 
  ...
  discount: function(teacher) {
   if(teacher === 'teacher') {
     const discountedPrice = burger.price - (burger.price * .25)
...
const createMenuItem = (name, cost, category) => {
...
console.log(reviews[5].feedback = 'New feedback');
console.log(reviews[5].rating = 4);
